    ...
    public static class Extension
    {
        ...
        public static GoogleMeetLogModel MapTransferObjectITAInModel(this IGoogleMeetLogTO googleMeetLogTO)
        {
            return new GoogleMeetLogModel
            {
                ...
                BitRationAudioSending = double.Parse(googleMeetLogTO.BitRationAudioSending),
                ...
                BitRationScreencastReception = double.Parse(googleMeetLogTO.BitRationScreencastReception),
                ...
                BitRationScreencastSending = double.Parse(googleMeetLogTO.BitRationScreencastSending),
                ...
                BitRationVideoSending = double.Parse(googleMeetLogTO.BitRationVideoSending),
        ...
        public static IGoogleMeetLogTO MapObjectModelInTransferObjectITA(this GoogleMeetLogModel googleMeetLogModel)
        {
            return new GoogleMeetLogTOITA
            {
                ...
                VisualizedDestinationName = googleMeetLogModel.VisualizedDestinationName,
                ...
                BitRationAudioSending = googleMeetLogModel.BitRationAudioSending.ToString(),
                ...
                BitRationScreencastReception = googleMeetLogModel.BitRationScreencastReception.ToString(),
                ...
                BitRationScreencastSending = googleMeetLogModel.BitRationScreencastSending.ToString(),
                ...
                BitRationVideoSending = googleMeetLogModel.BitRationVideoSending.ToString(),
                ...
                VideoSenfingDuration = googleMeetLogModel.VideoSenfingDuration.ToString(),
