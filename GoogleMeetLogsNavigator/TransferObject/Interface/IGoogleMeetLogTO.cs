...
namespace GoogleMeetLogsNavigator.TransferObject.Interface
{
    ...
    public interface IGoogleMeetLogTO
    {
        ...
        string VisualizedDestinationName { get; set; }
        ...
        string BitRationAudioSending { get; set; }
        ...
        string BitRationScreencastReception { get; set; }
        ...
        string BitRationScreencastSending { get; set; }
        ...
        string BitRationVideoSending { get; set; }
        ...
        string VideoSenfingDuration { get; set; }
